...
namespace Nov.MaxSamples.Beacons.Clients.Version1
{
    ...
    public class BeaconsGrpcClientV1Test : IDisposable
    {
        ...
        private BeaconsGrpcClientV1 _client;
        private BeaconsClientV1Fixture _fixture;

        public BeaconsGrpcClientV1Test()
        {
            _persistence = new BeaconsMemoryPersistence();
            _controller = new BeaconsController();
            _service = new BeaconsGrpcServiceV1();
            _client = new BeaconsGrpcClientV1();
