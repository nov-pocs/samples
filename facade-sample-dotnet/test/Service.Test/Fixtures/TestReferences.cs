...
using Nov.MaxApi.SampleFacade.Operations.Version1;
...
namespace Nov.MaxApi.SampleFacade.Fixtures
{
	public class TestReferences: ManagedReferences
	{
		...
		private void AppendDependencies()
		{
			...
			Put(new Descriptor("nov-services-sites", "client", "direct", "memory", "*"), new SitesMemoryClientV1());
		}
