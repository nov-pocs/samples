...
namespace Nov.MaxApi.SampleFacade.Operations.Version1
{
	public class SessionsOperationsV1 : RestOperations
	{
		...
		public SessionsOperationsV1()
		{
			...
			_dependencyResolver.Put("sites", new Descriptor("nov-services-sites", "client", "*", "*", "1.0"));
			_dependencyResolver.Put("invitations", new Descriptor("nov-services-invitations", "client", "*", "*", "1.0"));
		}
