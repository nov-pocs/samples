using Nov.MaxApi.SampleFacade.Clients.Version1;
...
namespace Nov.MaxApi.SampleFacade.Build
{
	public class ClientFacadeFactory: Factory
	{
		...
		public static Descriptor SitesMemoryClientV1Descriptor = new Descriptor("nov-services-sites", "client", "memory", "*", "1.0");
		public static Descriptor InvitationsNullClientV1Descriptor = new Descriptor("nov-services-invitations", "client", "null", "*", "1.0");
		public static Descriptor InvitationsMemoryClientV1Descriptor = new Descriptor("nov-services-invitations", "client", "memory", "*", "1.0");
		public static Descriptor BeaconsMemoryClientV1Descriptor = new Descriptor("nov-services-beacons", "client", "memory", "*", "1.0");
